...
fn body_text(w: &Widget) -> String {
    ...
    match w.kind {
        ...
        WidgetKind::LogView => "logview".to_string(),
        WidgetKind::Heatmap => "heatmap".to_string(),
        WidgetKind::Treemap => "treemap".to_string(),
        WidgetKind::Gantt => "gantt".to_string(),
        WidgetKind::Diff => "diff".to_string(),
        WidgetKind::Logo => "logo".to_string(),
        WidgetKind::Blank => "clear".to_string(),
